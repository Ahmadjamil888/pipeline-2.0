...
export default function ProductShowcase() {
	...
	const phares1 = ["How ZehanX Tech", "revolutionizes computing"];
	const phares2 = [
		"Access quantum processors through our cloud platform.",
		"Run quantum algorithms, solve complex problems,",
		"and unlock computational power beyond imagination.",
	];
	const phares3 = [
		"Access quantum processors through our cloud platform. Run quantum algorithms, solve complex problems, and unlock computational power beyond imagination.",
	];
	return (
